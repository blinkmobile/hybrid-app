(function () {
  ...
  paths = {
    BlinkForms: getPaths('blink/forms/3/3.2.0/forms3jqm.min'),
      ...
      getDataSuitcase: function (suitcase, time) {
        return new Promise(function (resolve, reject) {
          cordova.offline.retrieveContent(
            ...
            reject,
            {
              url: '/_R_/common/3/xhr/GetMoJO.php?_id=' + window.BMP.BIC.siteVars.answerSpaceId + '&_m=' + suitcase + '&_lc=0'
            }
          );
        });
      },
  ...
  function (uuid) {
    ...
    var API = {
      getAnswerSpaceMap: function (user) {
        ...
        //   }
        // );
        return $.ajax('https://blinkm.co/_R_/common/3/xhr/GetConfig.php?_asn=' + window.BMP.BIC.siteVars.answerSpace.toLowerCase() + userString);
      },
      ...
      getForm: function () {
        ...
        //   }
        // );
        return $.ajax('https://blinkm.co/_R_/common/3/xhr/GetForm.php?_v=3&_aid=' + window.BMP.BIC.siteVars.answerSpaceId);
      },
      ...
      getDataSuitcase: function (suitcase, time) {
        ...
        //   },
        //   {
        //     url: 'https://blinkm.co/_R_/common/3/xhr/GetMoJO.php?_id=' + window.BMP.BIC.siteVars.answerSpaceId + '&_m=' + suitcase + '&_lc=0'
        //   }
        // );
        return $.ajax('https://blinkm.co/_R_/common/3/xhr/GetMoJO.php?_id=' + window.BMP.BIC.siteVars.answerSpaceId + '&_m=' + suitcase + '&_lc=0', {dataType: 'text'});
      },
